...
import { openAssistant } from '../lib/personas';
          ...
          <div className="flex flex-col items-start text-left px-4 md:px-0 order-2 lg:order-1">
            ...
            <FadeIn delay={500} className="mt-8 flex flex-wrap justify-start gap-4 w-full">
              <HoverBorderGradient
                containerClassName="rounded-full"
                as="button"
                onClick={() => openAssistant('whatsapp')}
                className="text-gray-900 font-semibold text-sm flex items-center gap-2 bg-white/20 hover:bg-white/30"
              >
                <Sparkles className="w-4 h-4" />
          ...
          <div className="flex flex-col items-end text-right px-4 md:px-0 order-2">
            ...
            <FadeIn delay={500} className="mt-8 flex flex-wrap justify-end gap-4 w-full">
              <HoverBorderGradient
                containerClassName="rounded-full"
                as="button"
                onClick={() => openAssistant('instagram')}
    ...
    >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="text-xs space-y-2.5">
                ...
                <li><a href="/servicios" className="hover:text-white transition-colors block">Servicios</a></li>
                <li><a href="/proyectos" className="hover:text-white transition-colors block">Proyectos</a></li>
                <li><a href="/ecosistema" className="hover:text-white transition-colors block">Ecosistema</a></li>
                <li><a href="/precios" className="hover:text-white transition-colors block">Precios</a></li>
                <li><a href="/presupuesto" className="hover:text-white transition-colors block">Presupuesto</a></li>
                <li><a href="/contacto" className="hover:text-white transition-colors block">Contacto</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-xs space-y-2.5">
                <li><a href="/presupuesto" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors block">Agenda una llamada</a></li>
                <li><a href="/presupuesto" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors block">WhatsApp directo</a></li>
                ...
                <li><a href="/terminos" className="hover:text-white transition-colors block">Términos de servicio</a></li>
                <li><a href="/eliminacion-datos" className="hover:text-white transition-colors block">Eliminación de datos</a></li>
                <li><a href="/privacidad" className="hover:text-white transition-colors block">Privacidad (B2B)</a></li>
              </ul>
            </div>
      ...
      <div className="pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <a href="https://www.instagram.com/automatiza.gc" target="_blank" rel="noopener noreferrer" aria-label="Instagram @automatiza.gc" className="text-white/40 hover:text-white transition-colors">
            <Instagram size={15} />
          </a>
